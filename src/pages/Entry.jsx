...
const Entry = () => (
    <main class="contenedor">
        <h3 class="centrar-texto">Cafe</h3>

        <img src={blog1} alt="imagen del blog" />
        ...
        <p>
            ...
            tortor. Quisque nec gravida dui. Sed vitae massa mollis, porta felis sed,
            fringilla odio.
        </p>
        ...
        <p>
            ...
            iaculis elit et porta luctus. Orci varius natoque penatibus et magnis dis
            parturient montes, nascetur ridiculus mus. Maecenas lacinia est vitae eros
            posuere, non commodo justo viverra. Sed finibus id elit sit amet egestas.
            Nullam ac urna odio. Fusce vestibulum venenatis quam in scelerisque.
            Maecenas ultricies ultricies velit, non suscipit enim. Vivamus massa
            velit, lobortis fringilla laoreet in, suscipit vitae velit. Etiam at orci
            euismod magna rhoncus luctus. Curabitur viverra est ut elit gravida
